...
/**
* "Tiger" Class representing the characteristics of tiger for the game inherited from the Animal Class and implements the interface of the RiverJumpException because the tiger can jump through the river
* @author Airon John Cruz
* @author Julia Ann King
* @since 1.0
*/
public class Tiger extends Animal implements RiverJumpException {
	
	private boolean canJumpRiver;
	private boolean canGoRiver;
	
	/**
	* Constructor for the declaration of the characteristics of tiger
	...
	*/
	public Tiger(boolean team, int rank)
	{
		super(team, rank);
		canJumpRiver = true;
		canGoRiver = false;
	...
	/**
	* Method to get if the tiger can jump the river or not
	...
	*/
	...
	/**
	* Method to get if the tiger can be in the river
	* @return boolean		returns false because the tiger cannot go inside the river
	*/
	...
	/**
	* Boolean method for knowing if the capture of the tiger is valid or not
	...
	*/
	...
	/**
	* Method to show the jump of the tiger through the river
	* @return Position		returns the target tile and position of the tiger piece of the player
	*/
